...
# %% Prepare 2nd model df's for the chart
# record time data
effnetB4_2dur = round(endtime - starttime,2)
...
rhtTtl = 'CNN EffnetB4 with data augmentation'
...
lftTtl = 'CNN EffnetB4 with data augmentation'
rhtTtl = 'CNN EffnetB4 w/data aug and fine tuned'
...
tps.ChartMnistNetworkChanges(effnetB4_2df,effnetB4_3df, effnetB4_2mdlsum, 
                             effnetB4_2dur, effnetB4_2dur, effnetB4_3mdlsum, 
                             augmnt, supttl, lftTtl, rhtTtl)
